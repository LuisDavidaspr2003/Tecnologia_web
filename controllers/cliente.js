...
const createCliente = async (req = request, 
    ...
    try{
        ...
        const clienteDB = await Cliente.findOne({nombre})//select * from tipoProyecto where nombre=?
...
const getCliente = async (req = request, 
    res = response) => {
        try{
            ...
            const clienteDB = await Cliente.find()//select * from tipoProyecto where estado=?
